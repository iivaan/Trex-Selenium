 ...
 * search may or may not be successful. The convention in Trex for Findable types is that actually
 * being found does not necessarily predate their instantiation or existence. A "find" method may
 * return a Findable which is not actually there.
 * <p>
 * To test for the presence of a Findable, use {@link #isPresent()}.
 */
public interface Findable {
    /**
     * Tests for the presence of the {@link Findable}. A type that is
