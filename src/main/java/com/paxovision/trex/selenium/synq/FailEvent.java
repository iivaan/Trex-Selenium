...
public interface FailEvent<T> extends Event<T> {
    /**
     * Instead of throwing an {@link AssertionError}, throw an exception as created by the
    ...
    /**
     * Instead of throwing an {@link AssertionError}, throws a specific exception instance
     * instead.
     * <p>
     ...
     * <p>
     * While not as terse, it is encouraged to use {@link #throwing(Function)}
