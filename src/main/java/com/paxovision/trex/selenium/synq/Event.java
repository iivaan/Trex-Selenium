...
public interface Event<T> {
     ...
     * specified duration, at which point a {@link TimeoutException} will be
     * thrown.
     *
     ...
     * @throws TimeoutException if the specified amount of time passes before the
     * Event occurs.
     */
     ...
     * {@link TimeoutException TimeoutExceptions}, in the form, "Event occurs when
     * ${event.toString()}."
     *
